...
if __name__ == "__main__":
    ...
    parser.add_argument("--ea_model_path",type=str,default="/home/haiduo/model/eagle/Jakiro-llama2-chat-13B",help="The path to the weights.",)
    ...
    parser.add_argument("--answer_file", type=str,default="/home/haiduo/code/Jakiro/jakiro/outputs/results/llama2_chat_13b_Jakiro/1_gpu", help="The output path of answer file.")
