...
if __name__ == "__main__":
    ...
    parser.add_argument("--ea_model_path",type=str,default="/home/haiduo/model/eagle/EAGLE-Vicuna-7B-v1.3",help="The path to the weights.",)
    ...
    parser.add_argument("--answer_file", type=str,default="/home/haiduo/code/EAGLE/eagle/outputs/results/vicuna_7b_paper/algin_maxlen", help="The output path of answer file.")
