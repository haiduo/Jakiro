...
if __name__ == "__main__":
    ...
    parser.add_argument("--ea_model_path",type=str,default="/home/haiduo/code/EAGLE_MOE/eagle/outputs/checkpoints/vicuna_7b/moe_eagle/abalation/medusa_llama_mlp_cosin_epochs=20_lr=9e-5_wd=1e-3_sum", help="The path to the weights.",)
    ...
    parser.add_argument("--answer_file", type=str,default="/home/haiduo/code/EAGLE_medusa/eagle/outputs/our/vicuna_7b/moe_eagle/medusa_llama_mlp_cosin_epochs=20_lr=9e-5_wd=1e-3_sum/5_60/check4", help="The output path of answer file.")
