...
if __name__ == "__main__":
    ...
    parser.add_argument("--ea_model_path",type=str, default="/home/haiduo/code/EAGLE_MOE/eagle/outputs/checkpoints/llama3-8b/moe_eagle/medusa_llama_mlp_cosin_epochs=20_lr=9e-5_wd=1e-3", help="The path to the weights.",)
    ...
    parser.add_argument("--answer_file", type=str,default="/home/haiduo/code/EAGLE_medusa/eagle/outputs/our/Llama-3-8B-Instruct/moe_eagle/medusa_llama_mlp_cosin_epochs=20_lr=9e-5_wd=1e-3/tree_5_60/check4", help="The output path of answer file.")
    # parser.add_argument("--total_token", type=int, default=60, choices=[60,50,48], help="草稿过程新生成的token的最大数量",)
    parser.add_argument("--total_token", type=int, default=60, help="草稿过程新生成的token的最大数量",)
