...
if __name__ == "__main__":
    ...
    parser.add_argument("--ea-model_path",type=str,default="/home/haiduo/code/EAGLE_MOE/eagle/outputs/checkpoints/llama2_13b/eagle_llama2-13b_reproduced",help="The path to the weights.",)
    ...
    parser.add_argument("--answer_file", type=str,default="/home/haiduo/code/EAGLE/eagle/outputs/results/llama2_chat_13b_reproduced/1_gpu", help="The output path of answer file.")
