...
import gradio as gr #专门用于快速创建和共享机器学习模型的用户界面（UI）的Python库
import argparse
...
parser.add_argument("--ea_model_path", type=str, default="C:\\Users\\q\\Desktop\\EAGLE\\eagle\\outputs\\ckpts\\EAGLE-Vicuna-7B-v1.3", help="The path to the weights.")
parser.add_argument("--base_model_path", type=str, default="C:\\Users\\q\\Desktop\\EAGLE\\eagle\\outputs\\ckpts\\vicuna-7b-v1.3", help="path of basemodel")
