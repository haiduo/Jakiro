...
if __name__ == "__main__":
    ...
    parser.add_argument("--ea_model_path",type=str, default="/home/haiduo/code/EAGLE_MOE/eagle/outputs/checkpoints/vicuna_7b/moe_eagle/llama-mlp/moe_llama_mlp_same-dim_epoch=40_final-lr-1.5e-5_orig", help="The path to the weights.",)
    ...
    parser.add_argument("--answer_file", type=str, default="/home/haiduo/code/EAGLE_MOE/eagle/outputs/checkpoints/vicuna_7b/moe_eagle/llama-mlp/moe_llama_mlp_same-dim_epoch=40_final-lr-1.5e-5_orig/check4", help="The output answer file.")
