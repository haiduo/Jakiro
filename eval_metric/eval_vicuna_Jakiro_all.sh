...
model_id=eagle2-vicuna-7b-fp16
model_id_baseline=eagle2-vicuna-7b-fp16-baseline

answer_file=/home/haiduo/code/Jakiro/jakiro/outputs/A40/our_Jakiro/vicuna_7b
answer_file_base=/home/haiduo/code/Jakiro/jakiro/outputs/A40/paper_baseline/vicuna_7b
temperature=0.0
...
#     CUDA_VISIBLE_DEVICES=${GPU_DEVICES} python -m jakiro.evaluation.gen_ea_answer_vicuna \
...
#     CUDA_VISIBLE_DEVICES=${GPU_DEVICES} python -m jakiro.evaluation.gen_baseline_answer_vicuna \
#     --ea_model_path "$ea_model_path" \
#     --base_model_path "$base_model_path" \
