...
ea_model_path=/home/haiduo/code/Jakiro/eagle/outputs/checkpoints/llama2_7b/Jakiro_llama-mlp_cosin_epochs=20_lr=9e-5_wd=1e-3
base_model_path=/home/haiduo/model/llama/Llama-2-7b-chat-hf
model_id=eagle2-llama2-7b-fp16
model_id_baseline=eagle2-llama2-7b-fp16-baseline

answer_file=/home/haiduo/code/Jakiro/eagle/outputs/our/llama2_7b/Jakiro_llama-mlp_cosin_epochs=20_lr=9e-5_wd=1e-3
answer_file_base=/home/haiduo/code/Jakiro/eagle/outputs/paper/depth-5/llama2_7b
temperature=0.0
...
for bench_name in "${bench_names[@]}"; do
    ...
    CUDA_VISIBLE_DEVICES=${GPU_DEVICES} python -m jakiro.evaluation.gen_ea_answer_llama2chat \
...
for bench_name in "${bench_names[@]}"; do
    ...
    CUDA_VISIBLE_DEVICES=${GPU_DEVICES} python -m jakiro.evaluation.gen_baseline_answer_llama2chat \
    --ea_model_path "$ea_model_path" \
    --base_model_path "$base_model_path" \
...
for bench_name in "${bench_names[@]}"; do
    ...
    output=$(python -m jakiro.evaluation.speed_accept_len "$bench_name" "$base_model_path" "$jsonl_file_eagle" "$jsonl_file_base")
