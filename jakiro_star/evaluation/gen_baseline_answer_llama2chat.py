...
if __name__ == "__main__":
    ...
    parser.add_argument("--ea_model_path",type=str,default="/home/haiduo/model/eagle/EAGLE-llama2-chat-13B",help="The path to the weights.",)
    ...
    parser.add_argument("--model_id", type=str, default="ess-llama-2-chat-13b-fp16-baseline")
    ...
    parser.add_argument("--answer_file", type=str,default="/home/haiduo/code/EAGLE-1/eagle/outputs/results/llama2_chat_13b_baseline/1_gpu", help="The output path of answer file.")
