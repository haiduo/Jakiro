...
def get_model_answers(base_model_path, 
                      ea_model_path, 
                      model_id, 
                      questions, 
                      answer_file, 
...
if __name__ == "__main__":
    ...
    parser.add_argument("--ea-model_path",type=str,default="/home/haiduo/code/EAGLE_MOE/eagle/outputs/checkpoints/vicuna_7b/moe_eagle/simple_moe_e2k2_gpt_align/pw-0.4_lr-3e-5",help="The path to the weights.",)
    ...
    parser.add_argument("--model-id", type=str, default="eagle1-vicuna-7b-fp16-tmp")
    ...
    parser.add_argument("--answer_file", type=str,default="/home/haiduo/code/EAGLE-1/eagle/outputs/depth-6/simple_moe_e2k2_gpt_align/pw-0.4_lr-3e-5_2", help="The output path of answer file.")
