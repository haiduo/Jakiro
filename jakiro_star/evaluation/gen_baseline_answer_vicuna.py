...
if __name__ == "__main__":
    ...
    parser.add_argument("--ea_model_path", type=str, default="/home/haiduo/model/eagle/e2k2_pw_0.4",help="The path to the weights.",)
    ...
    parser.add_argument("--model_id", type=str, default="eagle1-vicuna-7b-fp16-baseline")
    ...
    parser.add_argument("--answer_file", type=str, default="/home/haiduo/code/EAGLE_1_MOE/eagle/outputs/vicuna_7b/moe_eagle/gpt-mlp/e2k2_pw_0.4", help="The output answer file.")
