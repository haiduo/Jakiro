...
from jakiro_star.model.ea_model import EaModel
from jakiro_star.model.kv_cache import initialize_past_key_values
from jakiro_star.model.utils_alpha import *
from jakiro_star.model.choices import *
...
def get_model_answers(
    ...
    for _ in range(3):
        ...
        for j in range(len(question["turns"])):
            ...
            output_ids, new_token, idx, alpha, alpha_num, accept_length = ea_forward(
...
if __name__ == "__main__":
    ...
    parser.add_argument("--ea-model_path",type=str,default="/home/haiduo/code/EAGLE_MOE/eagle/outputs/checkpoints/llama2_70b/eagle_llama2-70b_reproduced",help="The path to the weights.",)
    parser.add_argument("--base_model_path", type=str, default="/home/haiduo/model/llama/Llama-2-70b-chat-hf",help="1")
    parser.add_argument("--load_in_8bit", default=False, action="store_false", help="Use 8-bit quantization")
    parser.add_argument("--model_id", type=str, default="ess-llama-2-chat-70b-fp16")
    ...
    parser.add_argument("--answer_file", type=str,default="/home/haiduo/code/EAGLE-1/eagle/outputs/results/llama2_chat_70b_reproduced/4_gpu", help="The output path of answer file.")
