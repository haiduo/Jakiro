...
if __name__ == "__main__":
    ...
    parser.add_argument("--ea_model_path",type=str, default="/home/haiduo/model/eagle/EAGLE-LLaMA3-Instruct-8B", help="The po ID.",)
    ...
    parser.add_argument("--model_id", type=str, default="llama38b2_40-fp16-baseline")
    ...
    parser.add_argument("--answer_file", type=str,default="/home/haiduo/code/EAGLE1.5/eagle/outputs/our/Llama-3-8B-Instruct/orig/tree_5_60/check1", help="The output path of answer file.")
