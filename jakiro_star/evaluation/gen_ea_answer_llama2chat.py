...
if __name__ == "__main__":
    ...
    parser.add_argument("--ea_model_path",type=str,default="/home/haiduo/code/EAGLE_MOE/eagle/outputs/checkpoints/llama2_13b/simple_moe_e2k2_gpt-mlp/pw-1.0",help="The path to the weights.",)
    ...
    parser.add_argument("--answer_file", type=str,default="/home/haiduo/code/EAGLE-1/eagle/outputs/results/depth-6_1/llama2_13b/pw-1.0/check2", help="The output path of answer file.")
