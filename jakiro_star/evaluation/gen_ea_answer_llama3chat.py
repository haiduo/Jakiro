...
from jakiro_star.model.utils import *
from jakiro_star.model.choices import *


def ea_forward(input_ids, model, tokenizer, tree_choices, logits_processor=None, max_steps=512, is_llama3=False,):
    if is_llama3:
...
if __name__ == "__main__":
    ...
    parser.add_argument("--ea_model_path",type=str, default="/home/haiduo/code/EAGLE_MOE/eagle/outputs/checkpoints/llama3-8b/moe_eagle/llama3_8b_simple_e2k2_moe_gpt-mlp__epoch=20", help="The path to the weights.",)
    parser.add_argument("--base_model_path", type=str, default="/home/haiduo/model/llama/Meta-Llama-3-8B-Instruct", help="1")
    parser.add_argument("--load_in_8bit", default=False, action="store_false", help="Use 8-bit quantization")
    parser.add_argument("--model_id", type=str, default="llama38b2_40")
    ...
    parser.add_argument("--answer_file", type=str,default="/home/haiduo/code/EAGLE-1_MOE/eagle/outputs/our/Llama-3-8B-Instruct/llama_mlp/llama3_8b_simple_e2k2_moe_gpt-mlp__epoch=20/depth_6_1/orig/check4", help="The output path of answer file.")
