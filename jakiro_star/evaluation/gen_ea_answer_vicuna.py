...
if __name__ == "__main__":
    ...
    parser.add_argument("--ea_model_path",type=str, default="/home/haiduo/model/eagle/Jakiro_star_vicuna-7b", help="The path to the weights.",)
    ...
    parser.add_argument("--answer_file", type=str, default="/home/haiduo/code/Jakiro/jakiro_star/outputs/RTX4090", help="The output answer file.")
